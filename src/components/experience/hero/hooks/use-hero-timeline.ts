...
export function useHeroTimeline(rootRef: RefObject<HTMLElement | null>) {
  useEffect(() => {
    ...
    gsap.set(q("[data-sakura-left], [data-mist-crimson], [data-crimson-wash], [data-character-rim], [data-ground-glow], [data-temple-light], [data-moon-halo-crimson], [data-right-petals-after], [data-left-petals-after]"), { opacity: 0 });
    ...
    if (reduced) {
      timeline
        .to(q("[data-copy-intro]"), { opacity: 0, duration: 0.18 }, 0.4)
        .to(q("[data-copy-eclipse]"), { opacity: 1, y: 0, duration: 0.22 }, 0.48)
        .to(after, { opacity: 1, duration: 0.36 }, 0.42)
        .to(before, { opacity: 0.12, duration: 0.36 }, 0.42)
        .to(q("[data-sky-crimson]"), { opacity: 0.9, duration: 0.36 }, 0.42)
        .to(q("[data-moon-halo-crimson], [data-crimson-wash]"), { opacity: 0.8, duration: 0.3 }, 0.48);
    } else {
      timeline
        .to(q("[data-hero-camera]"), { scale: 1.012, xPercent: -0.2, yPercent: -0.12, duration: 0.16 }, 0)
        .to(q("[data-copy-intro]"), { y: -16, opacity: 0.35, duration: 0.12 }, 0.12)
        .to(q("[data-copy-intro]"), { y: -32, opacity: 0, duration: 0.08 }, 0.22)
        .to(q("[data-copy-omen]"), { y: 0, opacity: 1, duration: 0.11, ease: "power2.out" }, 0.2)
        .to(q("[data-phase-serene]"), { opacity: 0, duration: 0.08 }, 0.18)
        .to(q("[data-phase-omen]"), { opacity: 1, duration: 0.08 }, 0.21)
        ...
        .to(q("[data-moon-shadow]"), { xPercent: -4, opacity: 0.62, duration: 0.16, ease: "power1.inOut" }, 0.36)
        ...
        .to(q("[data-temple-after], [data-mist-after], [data-sakura-right-after]"), { opacity: 0.4, duration: 0.18 }, 0.38)
        .to(q("[data-temple-before], [data-mist-before], [data-sakura-right-before]"), { opacity: 0.78, duration: 0.18 }, 0.38)
        .to(q("[data-copy-omen]"), { y: -24, opacity: 0, duration: 0.1 }, 0.5)
        .to(q("[data-copy-eclipse]"), { y: 0, opacity: 1, duration: 0.12, ease: "power2.out" }, 0.53)
        .to(q("[data-phase-omen]"), { opacity: 0, duration: 0.07 }, 0.5)
        .to(q("[data-phase-eclipse]"), { opacity: 1, duration: 0.08 }, 0.54)
        ...
        .to(q("[data-temple-after], [data-ground-after], [data-characters-after], [data-sakura-right-after]"), { opacity: 0.82, duration: 0.2 }, 0.5)
        .to(q("[data-temple-before], [data-ground-before], [data-characters-before], [data-sakura-right-before]"), { opacity: 0.32, duration: 0.2 }, 0.5)
        .to(q("[data-sakura-left], [data-mist-crimson]"), { opacity: 0.58, duration: 0.18 }, 0.52)
        .to(q("[data-character-rim], [data-ground-glow], [data-temple-light]"), { opacity: 0.65, duration: 0.18 }, 0.54)
        .to(q("[data-crimson-wash]"), { opacity: 0.18, duration: 0.18 }, 0.56)
        .to(q("[data-left-petals-after], [data-right-petals-after]"), { opacity: 0.72, duration: 0.18 }, 0.58)
        ...
        .to(q("[data-hero-camera]"), { scale: 1.026, xPercent: -0.65, yPercent: -0.22, duration: 0.18 }, 0.68)
        .to(q("[data-hero-word]"), { opacity: 0.42, letterSpacing: "-0.045em", duration: 0.16 }, 0.72)
        .to(q("[data-hero-camera]"), { scale: 1.02, xPercent: -0.35, yPercent: -0.12, duration: 0.14, ease: "sine.out" }, 0.86)
    ...
    const trigger = ScrollTrigger.create({
      ...
      onUpdate: ({ progress }) => {
        ...
        const speed = progress < 0.12 ? 0.55 : progress < 0.48 ? 0.85 : progress < 0.86 ? 1.45 : 0.72;
    ...
    if (!reduced && !mobile) {
      ...
      const reset = () => pointerTargets.forEach((target) => {
        target?.x(0);
        target?.y(0);
      });
